    ...
    public function up()
    {
        if (!Schema::hasTable('settings')) {
            Schema::create('settings', function (Blueprint $table) {
                ...
                $table->string('experiense_years_count');
                $table->string('aboutus_viedo');
                $table->string('aboutus_image');
                $table->string('phone_booking_request');//Booking request
                $table->string('table_image');//Booking request
                $table->string('footer_text');//Booking request
