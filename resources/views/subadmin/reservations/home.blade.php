            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline mr-5">
                        <h3>{{ucwords(__('cp.reservations'))}}</h3>
                    </div>
                </div>
                <!--end::Info-->
                <!--begin::Toolbar-->
                ...
                <div>
                    <div class="btn-group mb-2 m-md-3 mt-md-0 ml-2 ">
                        <a class="btn btn-secondary" href="{{url(getLocal().'/admin/pdfreservations')}}">
                            <i class="icon-xl la la-file-pdf"></i>
                            <span>PDF</span>
                        </a>

                        <a class="btn btn-secondary" href="{{url(getLocal().'/admin/export/excel/reservations')}}">
            ...
            <div class="container">
                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        {{--                            <div class="card" >--}}
                        {{--                                <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/reservations')}}">--}}
                        {{--                                    <div class="row">--}}
                        {{--                                        <div class="col-md-4">--}}
                        ...
                        {{--                                            <a href="{{url(app()->getLocale().'/admin/reservations')}}" type="submit" class="btn sbold btn-default btnRest">{{__('cp.reset')}}--}}
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-25p"> {{ucwords(__('cp.persons'))}}</th>
                                    <th class="wd-25p"> {{ucwords(__('cp.date'))}}</th>
                                    <th class="wd-25p"> {{ucwords(__('cp.time'))}}</th>
                                ...
                                @forelse($items as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-25p">{{$one->full_name}}</td>
                                        <td class="v-align-middle wd-25p">{{$one->persons}}</td>
                                        <td class="v-align-middle wd-25p">{{$one->date}}</td>
                                        <td class="v-align-middle wd-25p">{{$one->time}}</td>
                                        <td class="v-align-middle wd-25p">{{$one->mobile}}</td>
                                        <td class="v-align-middle wd-25p">{{Str::limit($one->description_details, 10, ' ...') }}</td>
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            <a href="{{url(getLocal().'/provider/reservations/'.$one->id.'/show')}}"
