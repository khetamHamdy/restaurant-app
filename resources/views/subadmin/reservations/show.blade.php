        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{url(getLocal().'/provider/reservations')}}"
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <form enctype="multipart/form-data" class="form-horizontal"
                          action="{{url(app()->getLocale().'/provider/reservations/'.$item->id)}}" method="post"
                          role="form" id="form">
                        {{ csrf_field() }}
                        {{ method_field('PATCH')}}
                        ...
                        <div class="row col-sm-12">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{__('cp.full_name')}}</label>
                                            <input type="text" class="form-control form-control-solid"
                                                   name="full_name" value="{{old('name',@$item->full_name)}}" disabled/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                   name="persons" value="{{old('persons',@$item->persons)}}" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                   name="time" value="{{old('time',@$item->time)}}" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                   name="date" value="{{old('date',@$item->date)}}" disabled/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control"
                                                      ...
                                                      disabled>{{$item->description_details}}</textarea>
                                        </div>
                                    </div>
                                </div>
