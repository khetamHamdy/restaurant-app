        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <form method="post" action="{{url(app()->getLocale().'/provider/meals/'.$item->id)}}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control-solid"
                                                   name="sort_order" min="0" value="{{@$item->sort_order}}" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control-solid"
                                                   name="price" min="0" value="{{@$item->price}}" required/>
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control select2" id="role" name="category_id"
                                                ...
                                                @foreach($categories as $categoryItem)
                                                    <option
                                                        ...
                                                        {{$categoryItem->id == $item->category_id?'selected':''}}
                                                    >{{$categoryItem->name}}
                                                    </option>
                                                @endforeach
                                            </select>
