                ...
                <table width="100%">
                    <tr>
                        <td style="border-radius: 15px;text-align: center;padding: 20px;">
                            <a><img src="{{url('web/emails/img/logo.svg')}}" alt="" title="Logo" width="80px" /></a>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="text-align: center;">
                <table width="100%">
                    <tr>
                        <td style="text-align: center">
                            {{--                            <p style="font-size: 16px;margin-bottom: 0px;margin-top: 40px;color:#000;font-weight: 600;">@lang('api.hello1')</p>--}}
                            <strong style="color: #482366;font-size: 27px;margin-bottom: 10px;display: block;font-weight: 500">@lang('cp.invoice')</strong>
                            <span style="color:#F0483E;border: 1px solid #F0483E; padding: 0 15px;font-weight: 600;font-size: 17px;margin-bottom: 30px;display: inline-block;">{{@$item->provider->name}}</span>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td style="background:rgb(156 117 181 / 4%);;padding:15px 40px">
                            ...
                            <table width="60%" style="margin-inline-start: auto;">
                                <tr>
                                    <td>
                                        <div class="to--pro"><strong style="color: #F0483E">@lang('api.grand_total')</strong><strong style="color: #F0483E">{{$item->total}} @lang('api.$')</strong></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table class="colom" style="width: 100%;border-radius: 15px;height: 200px;">
                                <tr width="100%" style="vertical-align: top">
                                    <td width="100%">
                                        ...
                                        <p style="color:#2A2B2C;font-size: 14px">@lang('api.payment_method') : {{$item->payment_method=='1' ? __('api.online'): __('api.cash_on_pickup')}}</p>
                                        <p style="color:#2A2B2C;font-size: 14px">@lang('api.payment_status') : {{@$item->payment_status==1 ?__('cp.payed') : __('cp.not_payed')}}</p>
                                        <p style="color:#2A2B2C;font-size: 14px">@lang('api.invoice_reference') : {{@$item->payment_id}}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table class="colom" style="width: 100%;">
                                <tr width="100%">
                                    <td width="100%" style="text-align: right;">
                                        ...
                                        <p style="color:#2A2B2C;font-size: 14px">@lang('api.order_id') : #{{$item->id}}</p>
                                        <p style="color:#2A2B2C;font-size: 14px">@lang('api.order_date') : {{$item->created_at->format('d/m/Y')}}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
