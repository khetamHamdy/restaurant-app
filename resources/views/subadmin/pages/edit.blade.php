        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <form method="post" action="{{url(app()->getLocale().'/provider/pages/'.$item->id)}}"
                                ...
                                <div class="col-md-8">
                                    <div class="fileinputForm">
                                        ...
                                        <div class="fileinput-new thumbnail"
                                            ...
                                            <img src="{{$item->image}}" id="editImage3">
                                        </div>
                                ...
                                @foreach($locales as $locale)
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " {{($locale->lang == 'ar') ? 'dir=rtl' :'' }} name="title_{{$locale->lang}}"
                                                      id="order" value="{!! @$item->translate($locale->lang)->title!!}" required/>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
