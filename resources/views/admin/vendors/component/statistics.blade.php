                    ...
                    <div class="card-body">
                        ...
                        <span
                            class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 text-hover-primary d-block">
                                    {{$item->productComments()->count()}}
                                </span>

                        <a href="#"><span class="font-weight-bold text-white font-size-sm">{{__('comments')}}</span></a>

                        <!--end::Body-->
                    </div>
                </div>
                <div class="card card-custom ql-bg-info gutter-b">
                    <div class="card-body">
                        ...
                        <span
                            class="card-title font-weight-bolder text-black-100 font-size-h2 mb-0 mt-6 text-hover-primary d-block">
                                    {{$item->productReports()->count()}}
                                </span>

                        <a href="#"><span class="font-weight-bold text-black-100 font-size-sm">{{__('reports')}}</span></a>
