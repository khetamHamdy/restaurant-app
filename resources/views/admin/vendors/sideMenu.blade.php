                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="py-9">
                            @if($item->user)
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="font-weight-bold mr-2">{{__('cp.user')}}:</span>
                                    <span class="text-muted">{{$item->user->user_name}}</span>
                                </div>
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="font-weight-bold mr-2">{{__('cp.phone')}}:</span>
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <div class="navi-item mb-2">
                                <a href=""
                                   class="navi-link py-4 @if(Route::currentRouteName() == "admin") active  @endif click_action_product"
                                   data-req="change_price">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                         xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <span class="navi-text font-size-lg">{{__('cp.change_price')}}</span>
                                </a>
                            </div>
