...
@section('title') {{ucwords(__('cp.services'))}}
@endsection
@section('css')
@endsection
@section('content')
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <a href="{{url(getLocal().'/admin/services')}}" class="btn btn-secondary  mr-2">{{__('cp.cancel')}}</a>
                    ...
                    <form method="post" action="{{url(app()->getLocale().'/admin/services')}}"
                        ...
                        <div class="row col-sm-12">
                            ...
                            @foreach($locales as $locale)
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>{{__('cp.details')}} <span class="text-danger"> {{$locale->name}} <span></label>
                                                    <textarea class="form-control ckEditor-y" {{($locale->lang == 'ar') ? 'dir=rtl' :'' }} name="details_{{$locale->lang}}"
