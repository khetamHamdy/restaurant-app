        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="{{ url(app()->getLocale().'/admin/home') }}" class="brand-logo">
                    <img alt="Logo" src="{{@$setting->favicon}}" style="max-width: 60px;"/>
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                    ...
                    <ul class="menu-nav">
                        ...
                        @if(can(['vendor-show' , 'vendor-edit' , 'vendor-delete']))
                            <li class="menu-item {{(explode("/", request()->url())[5] == "vendors") ? "menu-item-here" : ''}}"
                                aria-haspopup="true">
                                <a href="{{url(getLocal().'/admin/vendors')}}" class="menu-link">
											  <span class="svg-icon menu-icon">
                                    ...
                                    <span class="menu-text">{{__('cp.vendors')}}</span>
