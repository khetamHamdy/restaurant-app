        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="{{ url(app()->getLocale().'/provider/home') }}" class="brand-logo">
                    <img alt="Logo" src="{{url(asset(auth('subadmin')->user()->image))}}" style="max-width: 60px;"/>
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-submenu @if((explode("/", request()->url())[5] == "meals") | (Route::currentRouteName()=='provider.mealsReport')) menu-item-open @endif"
                            aria-haspopup="true"
                            data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Food/French Bread.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item  {{(explode("/", request()->url())[5] == "meals") ? "menu-item-here" : ''}}"
                                        aria-haspopup="true">
                        ...
                        {{--                        <li class="menu-item menu-item-submenu @if((explode("/", request()->url())[5] == "orders") | (Route::currentRouteName()=='provider.ordersReport')) menu-item-open @endif"--}}
                        {{--                            aria-haspopup="true"--}}
                        {{--                            data-menu-toggle="hover">--}}
                        {{--                            <a href="javascript:;" class="menu-link menu-toggle">--}}
                        {{--										<span class="svg-icon menu-icon">--}}
                        {{--											<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Layout/Layout-arrange.svg--><svg--}}
                        {{--                                                xmlns="http://www.w3.org/2000/svg"--}}
                        {{--                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"--}}
                        {{--                                                viewBox="0 0 24 24" version="1.1">--}}
                        {{--                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
                        ...
                        {{--                                        </a>--}}
                        {{--                                    </li>--}}
                        {{--                                    <li class="menu-item   {{(Route::currentRouteName()=='admin.ordersReport') ? "menu-item-here" : ''}}"--}}
                        {{--                                        aria-haspopup="true">--}}
                        ...
                        <li class="menu-item {{(explode("/", request()->url())[5] == "chefs") ? "menu-item-here" : ''}}"
                            aria-haspopup="true">
                            <a href="{{url(getLocal().'/provider/chefs')}}" class="menu-link">
										<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Git2.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                                viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="menu-text">{{__('cp.chefs')}}</span>
                            </a>
                        </li>

                        <li class="menu-item {{(explode("/", request()->url())[5] == "usAbout") ? "menu-item-here" : ''}}"
                            aria-haspopup="true">
                            <a href="{{url(getLocal().'/provider/usAbout')}}" class="menu-link">
										<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Code/Git2.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                ...
                                <span class="menu-text">{{__('cp.usAbout')}}</span>
                            </a>
                        </li>
                        ...
                        @if(can(['contacts-show' , 'contacts-edit' , 'contacts-delete']))
                            <li class="menu-item {{(explode("/", request()->url())[5] == "contacts") ? "menu-item-here" : ''}}"
                                aria-haspopup="true">
                                <a href="{{url(getLocal().'/provider/contacts')}}" class="menu-link">
											  <span class="svg-icon menu-icon">
                                    ...
                                    @php
                                        $contacts_count=\App\Models\Contact::query()->where('user_id', auth('subadmin')->id())
                        ...
                        @if(can(['reservations-show' , 'reservations-edit' , 'reservations-delete']))
                            <li class="menu-item {{(explode("/", request()->url())[5] == "reservations") ? "menu-item-here" : ''}}"
                                aria-haspopup="true">
                                <a href="{{url(getLocal().'/provider/reservations')}}" class="menu-link">
											  <span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Layout/Layout-arrange.svg--><svg
                                                      xmlns="http://www.w3.org/2000/svg"
                                                      xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                    ...
                                    <span class="menu-text">{{__('cp.reservations')}}</span>

                                    @php
                                        $reservations_count=\App\Models\Reservation::query()->where('vendor_id',auth('subadmin')->id())
                                        ->where('is_read','0')->count();
                                    @endphp
                                    @if($reservations_count>0)
                                        <span class="label label-rounded label-danger">{{$reservations_count}}</span>
                                    @endif
                        ...
                        @if(can(['slider-show', 'slider-edit']))
                        ...
                        "
                                ...
                                <a href="{{url(getLocal().'/provider/sliders')}}" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
                        ...
                        @if(can(['gallery-show', 'gallery-edit']))
                            <li class="menu-item menu-item-submenu {{(explode("/", request()->url())[5] == "gallery") ? "menu-item-here" : ''}}
                          @if(app()->getLocale() == 'ar')
                        {{(explode("/", request()->url())[5] == "gallery") ? "menu-item-here" : ''}}
                          @endif
                        "
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{url(getLocal().'/provider/gallery')}}" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        @if(can(['pages-show', 'pages-edit']))
                            <li class="menu-item {{(explode("/", request()->url())[5] == "pages") ? "menu-item-here" : ''}}"
                                aria-haspopup="true">
                                <a href="{{url(getLocal().'/provider/pages')}}" class="menu-link">
											<span class="svg-icon menu-icon">
                        ...
                        <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                            ...
                            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                <li class="breadcrumb-item">
                                    <a href="{{url(app()->getLocale().'/provider/home')}}"
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-item">
                            <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                ...
                                <span
                                    class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{auth()->guard('subadmin')->user()->name}}</span>
                                <span class="symbol symbol-35 symbol-light-success">
											<span
                                                class="symbol-label font-size-h5 font-weight-bold">{{mb_substr(auth()->guard('subadmin')->user()->name,0,1,'utf-8')}}</span>
										</span>
                            </div>
                        </div>
                        <!--end::User-->
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label"
                     style="background-image:url('{{auth()->guard('subadmin')->user()->image}}')"></div>
                <i class="symbol-badge bg-success"></i>
            </div>
            <div class="d-flex flex-column">
                <a href="#"
                   class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{auth()->guard('subadmin')->user()->name}}</a>
                ...
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span
                                        class="navi-text text-muted text-hover-primary">{{auth()->guard('subadmin')->user()->email}}</span>
								</span>
                    </a>
                    <a href="{{url(getLocal().'/provider/logout')}}"
